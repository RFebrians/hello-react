  ...
  return (
    <HelmetProvider>
      ...
      <div className="ab_block">
        ...
        <ReactEmbedGist gist="RFebrians/3cd65295ae4653e50863268682b9b5c0" file="MyButtonComponent.js" />
      ...
      <ReactEmbedGist gist="RFebrians/3cd65295ae4653e50863268682b9b5c0" file="MyPage.js" />
      <li> Gunakan import MyButtonComponent from "./MyButtonComponent" untuk men-impor </li>
      <li> </li>
      </div>
    </HelmetProvider>
  );
